...
<asp:SqlDataSource ID="SqlDSProduct" runat="server" ConnectionString="<%$ ConnectionStrings:CategoryConnection %>" 
            ...
            <div class="box-product">
                    <div class="align-center">
                        ...
                        <ItemTemplate >
                                <div class="img"><img src="img/product/<%# Eval("ProductID")%>.jpg" width="300" height="225" alt="" /></div>
            ...
            <asp:Repeater id="rpProductList" runat="server" DataSourceID="SqlDSProductList">
                        ...
                        <ItemTemplate>
                                ...
                                <div class="image"><a href="Category.aspx?ProductID=<%# Eval("ProductID")%>"><img src="img/products/<%# Eval("ProductID")%>.jpg" width="300" height="225" alt="" /></a></div>
